...
@section('title', 'Login - ' . config('panel.name'))
        ...
        <div id="login-tab" class="tab-content active">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username" value="{{ old('username') }}" required placeholder="Masukkan username atau email">
                </div>
        ...
        <div id="register-tab" class="tab-content">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="reg_username" value="{{ old('reg_username') }}" required placeholder="Pilih username unik">
                </div>
                
                <div class="form-group">
                    <label><i class="fas fa-envelope"></i> Email</label>
                    <input type="email" name="reg_email" value="{{ old('reg_email') }}" required placeholder="alamat@email.com">
                </div>
                
                <div class="form-group">
                    <label><i class="fas fa-id-card"></i> Nama Lengkap</label>
                    <input type="text" name="reg_fullname" value="{{ old('reg_fullname') }}" required placeholder="Nama lengkap Anda">
                </div>
